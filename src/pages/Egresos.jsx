        ...
        <div className="card">
          ...
          <form onSubmit={guardarEgresos}>
            <div className="table-wrap">
              <table className="table-excel table-egresos">
                <thead>
                  <tr>
                ...
                <tbody>
                  {filas.map((f, i) => (
                    <tr key={i}>
                      <td>
                        <input type="text" value={f.producto} onChange={(e)=> handleChange(i, "producto", e.target.value)} placeholder="Ej: Suprema" inputMode="search" />
                      </td>
                      <td>
                        <input type="number" min="0" step="1" inputMode="numeric" value={f.cantidad} onChange={(e)=> handleChange(i, "cantidad", e.target.value)} />
                      </td>
                      <td>
                        <input type="number" min="0" step="0.01" inputMode="decimal" value={f.kg} onChange={(e)=> handleChange(i, "kg", e.target.value)} />
                      </td>
                      <td>
