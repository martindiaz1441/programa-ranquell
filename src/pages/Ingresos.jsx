...
export default function Produccion() {
  ...
  const ejecutarDesposte = async () => {
    ...
    try {
      await commitEgresos([{ nombre: origen, categoria: "", tipo: u > 0 ? "unidad" : "kg", kg, unidades: u, motivo: "desposte" }], userNombre);
        ...
        <div className="card">
          ...
          <div className="form-row">
            ...
            <div className="form-col">
              ...
              <input type="number" min="0" step="0.01" value={desposte.kg}
                     onChange={(e)=> setDesposte(d => ({ ...d, kg: e.target.value }))}/>
            </div>

            <div className="form-col">
              <label>Unidades (opcional)</label>
              <input type="number" min="0" step="1" value={desposte.unidades}
